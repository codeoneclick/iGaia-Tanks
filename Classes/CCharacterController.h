...
class CCharacterController : public virtual CMoveControllerCallback_INTERFACE, public virtual CMainLoopUpdateCallback_INTERFACE
{
private:
    ...
    E_MOVE_CONTROLLER_DIRECTION m_direction;
    glm::vec3 m_position;
    glm::vec3 m_rotation;
