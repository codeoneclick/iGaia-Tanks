...
CTankLightTrack::CTankLightTrack(void)
{
    ...
    m_fLeftTrackTotalHealth = 100;
    m_fLeftTrackCurrentHealth = 100;
    
    m_fRightTrackTotalHealth = 100;
    m_fRightTrackCurrentHealth = 100;
}
...
{
    m_pLeftTrack = (CModel*)CSceneMgr::Instance()->Add_CustomModel("tank_light_left_track.mdl", IResource::E_THREAD_ASYNC);
    ...
    m_pRightTrack = (CModel*)CSceneMgr::Instance()->Add_CustomModel("tank_light_right_track.mdl", IResource::E_THREAD_ASYNC);
