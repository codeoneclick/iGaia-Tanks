...
{
    m_pLeftTrack = (CModel*)CSceneMgr::Instance()->Add_CustomModel("tank_medium_left_track.mdl", IResource::E_THREAD_ASYNC);
    ...
    m_pRightTrack = (CModel*)CSceneMgr::Instance()->Add_CustomModel("tank_medium_right_track.mdl", IResource::E_THREAD_ASYNC);
