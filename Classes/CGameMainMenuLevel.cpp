...
void CGameMainMenuLevel::Load(void)
{
    ...
    pLandscapeEdges->Set_Texture("layer_02_diffuse.pvr",  0, CTexture::E_WRAP_MODE_REPEAT, IResource::E_THREAD_SYNC);
    pLandscapeEdges->Set_Texture("layer_03_normal.pvr",  1, CTexture::E_WRAP_MODE_REPEAT, IResource::E_THREAD_SYNC);
    ...
    m_pGrass->Set_Texture("mod_02.pvr", 0, CTexture::E_WRAP_MODE_CLAMP, IResource::E_THREAD_ASYNC);
