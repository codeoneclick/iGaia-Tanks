...
unsigned int MemoryStream::readUTF8(FString &str)
{
...
unsigned int MemoryStream::readUTF8(FString &str, unsigned short length)
{
    if (length == 0)
    {
        return length;
...
unsigned int MemoryStream::writeUTF8( const FString &str )
{
