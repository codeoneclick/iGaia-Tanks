...
${OBJECTDIR}/Source/BoundedBufferReader.o: Source/BoundedBufferReader.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Source/BoundedBufferReader.o Source/BoundedBufferReader.cpp

${OBJECTDIR}/Source/AppApi.o: Source/AppApi.cpp 
	${MKDIR} -p ${OBJECTDIR}/Source
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Source/AppApi.o Source/AppApi.cpp

${OBJECTDIR}/Source/MemoryStream.o: Source/MemoryStream.cpp 
	${MKDIR} -p ${OBJECTDIR}/Source
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Source/MemoryStream.o Source/MemoryStream.cpp

${OBJECTDIR}/Source/DynamicMemoryStream.o: Source/DynamicMemoryStream.cpp 
	${MKDIR} -p ${OBJECTDIR}/Source
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Source/DynamicMemoryStream.o Source/DynamicMemoryStream.cpp

${OBJECTDIR}/pch.o: pch.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/pch.o pch.cpp

${OBJECTDIR}/Source/Invoker.o: Source/Invoker.cpp 
	${MKDIR} -p ${OBJECTDIR}/Source
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Source/Invoker.o Source/Invoker.cpp

${OBJECTDIR}/Source/MemoryStreamExceptions.o: Source/MemoryStreamExceptions.cpp 
	${MKDIR} -p ${OBJECTDIR}/Source
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Source/MemoryStreamExceptions.o Source/MemoryStreamExceptions.cpp

${OBJECTDIR}/Source/FileStream.o: Source/FileStream.cpp 
	${MKDIR} -p ${OBJECTDIR}/Source
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Source/FileStream.o Source/FileStream.cpp

${OBJECTDIR}/Source/Logger.o: Source/Logger.cpp 
	${MKDIR} -p ${OBJECTDIR}/Source
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Source/Logger.o Source/Logger.cpp

${OBJECTDIR}/Source/Common.o: Source/Common.cpp 
	${MKDIR} -p ${OBJECTDIR}/Source
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Source/Common.o Source/Common.cpp
