...
//	}
	...
	{
		m_[0][0] = gswf_math::flerp(m1.m_[0][0], m2.m_[0][0], t);
		m_[1][0] = gswf_math::flerp(m1.m_[1][0], m2.m_[1][0], t);
		m_[0][1] = gswf_math::flerp(m1.m_[0][1], m2.m_[0][1], t);
		m_[1][1] = gswf_math::flerp(m1.m_[1][1], m2.m_[1][1], t);
		m_[0][2] = gswf_math::flerp(m1.m_[0][2], m2.m_[0][2], t);
		m_[1][2] = gswf_math::flerp(m1.m_[1][2], m2.m_[1][2], t);
	}
	...
	// errors in tesselation.
	{
		...
		float	max_length2 = gswf_math::fmax(basis0_length2, basis1_length2);
	...
	// Apply our transform to the given color; return the result.
	{
		...
		result.m_r = (Uint8) gswf_math::fclamp(in.m_r * m_[0][0] + m_[0][1], 0, 255);
		result.m_g = (Uint8) gswf_math::fclamp(in.m_g * m_[1][0] + m_[1][1], 0, 255);
		result.m_b = (Uint8) gswf_math::fclamp(in.m_b * m_[2][0] + m_[2][1], 0, 255);
		result.m_a = (Uint8) gswf_math::fclamp(in.m_a * m_[3][0] + m_[3][1], 0, 255);
	...
	{
		m_[0][0] = gswf_math::fclamp(m_[0][0], 0, 1);
		m_[1][0] = gswf_math::fclamp(m_[1][0], 0, 1);
		m_[2][0] = gswf_math::fclamp(m_[2][0], 0, 1);
		m_[3][0] = gswf_math::fclamp(m_[3][0], 0, 1);

		m_[0][1] = gswf_math::fclamp(m_[0][1], -255.0f, 255.0f);
		m_[1][1] = gswf_math::fclamp(m_[1][1], -255.0f, 255.0f);
		m_[2][1] = gswf_math::fclamp(m_[2][1], -255.0f, 255.0f);
		m_[3][1] = gswf_math::fclamp(m_[3][1], -255.0f, 255.0f);
	}
	...
	{
		m_r = (Uint8) gswf_math::frnd(gswf_math::flerp(a.m_r, b.m_r, f));
		m_g = (Uint8) gswf_math::frnd(gswf_math::flerp(a.m_g, b.m_g, f));
		m_b = (Uint8) gswf_math::frnd(gswf_math::flerp(a.m_b, b.m_b, f));
		m_a = (Uint8) gswf_math::frnd(gswf_math::flerp(a.m_a, b.m_a, f));
	}
...
//		IF_DEBUG(log_msg("rect::read() nbits = %d\n", nbits));
	...
	{
		m_x_min = gswf_math::fmin(m_x_min, x);
		m_y_min = gswf_math::fmin(m_y_min, y);
		m_x_max = gswf_math::fmax(m_x_max, x);
		m_y_max = gswf_math::fmax(m_y_max, y);
	}
	...
	{
		m_x_min = gswf_math::flerp(a.m_x_min, b.m_x_min, t);
		m_y_min = gswf_math::flerp(a.m_y_min, b.m_y_min, t);
		m_x_max = gswf_math::flerp(a.m_x_max, b.m_x_max, t);
		m_y_max = gswf_math::flerp(a.m_y_max, b.m_y_max, t);
	}
